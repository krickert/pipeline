package com.rokkon.testing.server.containers;
...
public class ModuleContainerResource implements QuarkusTestResourceLifecycleManager {
    ...
    /** Default gRPC port used by the unified server */
    protected static final int DEFAULT_GRPC_PORT = 39100;
    /** Default HTTP port used by the unified server (same as gRPC port) */
    protected static final int DEFAULT_HTTP_PORT = 39100;
