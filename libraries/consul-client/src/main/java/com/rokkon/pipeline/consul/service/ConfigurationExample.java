...
public class ConfigurationExample {
    ...
    @Inject
    GlobalModuleRegistryServiceImpl registryService;
     ...
     * @param host The host address where the module is running
     * @param port The port number where the module is listening
     */
