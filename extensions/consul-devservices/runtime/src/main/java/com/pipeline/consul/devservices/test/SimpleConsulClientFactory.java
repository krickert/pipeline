 ...
 * This factory reads configuration from system properties set by DevServices
 * and creates a client instance that can be reused across tests.
 */
public class SimpleConsulClientFactory {
    ...
    public static synchronized ConsulClient getTestClient() {
        if (testClient == null) {
            ...
            // For @QuarkusIntegrationTest, these properties are passed to the packaged app
